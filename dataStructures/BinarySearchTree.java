...
public class BinarySearchTree {
    ...
    class Node {
        ...
        /**
         * @param newNode
         *         If you encounter an on-null node reference,look at its data value. If the data value of that node is
         *         larger than the value you want to insert, continue the process with the left child. If the node’s
         *         data value is smaller than the one you want to insert, continue the process with the right child. If
         *         the node’s data value is the same as the one you want to insert, you are done, because a set does not
